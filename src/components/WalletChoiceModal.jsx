            ...
            <div className="relative bg-[#1A1025] border border-[#C084FC]/30 w-full max-w-md rounded-[2.5rem] shadow-[0_30px_100px_rgba(0,0,0,0.8),0_0_50px_rgba(192,132,252,0.1)] overflow-hidden animate-slide-down">
                ...
                <div className="p-8 flex flex-col gap-4">
                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[10px] font-bold text-white/40 tracking-widest uppercase mt-1">EVM // WALLET_CONNECT</span>
                        </div>
                    </button>
                    ...
                    >
                        ...
                        <div className="flex flex-col">
                            ...
                            <span className="text-[10px] font-bold text-white/40 tracking-widest uppercase mt-1">NATIVE // HASHPACK_EXTENSION</span>
                        </div>
                    </button>
                ...
                <div className="p-6 bg-black/40 border-t border-white/5 text-center">
                    <p className="text-[9px] font-bold text-white/20 uppercase tracking-[0.3em]">
                        Ensure your wallet is toggled to TESTNET mode.
                    </p>
                </div>
            </div>
        </div>
